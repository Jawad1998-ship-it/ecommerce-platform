  ...
  useEffect(() => {
    ...
    const searchProducts = async () => {
      try {
        ...
        const response = await get(`/products/search?${searchParams.toString()}`);
    ...
    searchProducts();
  }, [query, category, currentPage, get]);
        ...
        {searchResults && (
          <div className="mb-6">
            ...
            <p className={`text-sm ${
              ...
              {searchResults.pagination.totalItems} results for "{searchResults.searchInfo.query}"
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
              {searchResults.products.map((product) => (
                <div key={product._id} className={`rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 ${
                  theme === "dark" ? "bg-gray-800" : "bg-white"
                }`}>
                  <Link href={`/products/${encodeURIComponent(product.name)}/dp/${product._id}`}>
